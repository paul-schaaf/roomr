 ...
 *  the first input should
 *  always render the entire timeArray array and
 *  therefore doesnt need a "start" property
 *  the second input starts at a certain point in
 *  the array because it *has* to be later than the time in the first input
 *  e.g. if you start your desired reserved time at 10:30,
 * it will automatically set your end to 10:45 and you can still
 ...
 * the state change is then done in the ComponentDidUpdate function
 * in Form.js so the state represents what you see
 */

const InputTimes = ({ start }) => {
  const timeArray = [
    '09:00',
    '09:15',
    '09:30',
  ...
  const index = timeArray.indexOf(start);
