...
const Room = ({ roomData }) => {
  ...
  /*
  * every room in the database has a 'times' array with objects that hold a timespan and the corresponding availability
  * of the room, e.g. "09:15" and true. We loop over the times array to create an li element for each timespan.
  * we use the availability property to give the div inside the li a class of either green or red, making the html block
